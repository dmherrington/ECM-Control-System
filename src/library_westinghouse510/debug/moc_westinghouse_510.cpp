...
QT_MOC_LITERAL(8, 137, 22), // "signal_PumpInitialized"
QT_MOC_LITERAL(9, 160, 29), // "slot_SerialPortReadyToConnect"
QT_MOC_LITERAL(10, 190, 21), // "slot_SerialPortUpdate"
QT_MOC_LITERAL(11, 212, 6), // "update"
QT_MOC_LITERAL(12, 219, 27), // "slot_SerialPortReceivedData"
QT_MOC_LITERAL(13, 247, 4), // "data"
QT_MOC_LITERAL(14, 252, 31) // "slot_PumpInitializationComplete"

    },
    "Westinghouse510\0signal_PumpCommunicationUpdate\0"
    "\0common::comms::CommunicationUpdate\0"
    "obj\0signal_PumpFlowUpdated\0value\0"
    "signal_PumpOperating\0signal_PumpInitialized\0"
    "slot_SerialPortReadyToConnect\0"
    "slot_SerialPortUpdate\0update\0"
    "slot_SerialPortReceivedData\0data\0"
    "slot_PumpInitializationComplete"
};
...
void Westinghouse510::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->signal_PumpInitialized(); break;
        case 4: _t->slot_SerialPortReadyToConnect(); break;
        case 5: _t->slot_SerialPortUpdate((*reinterpret_cast< const common::comms::CommunicationUpdate(*)>(_a[1]))); break;
        case 6: _t->slot_SerialPortReceivedData((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 7: _t->slot_PumpInitializationComplete(); break;
        default: ;
        }
        ...
        {
            typedef void (Westinghouse510::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Westinghouse510::signal_PumpInitialized)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void Westinghouse510::signal_PumpInitialized()
{
