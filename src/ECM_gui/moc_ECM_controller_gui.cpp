...
QT_MOC_LITERAL(3, 41, 18), // "slot_NewSensorData"
QT_MOC_LITERAL(4, 60, 25), // "common::TupleSensorString"
QT_MOC_LITERAL(5, 86, 6), // "sensor"
QT_MOC_LITERAL(6, 93, 17), // "data::SensorState"
QT_MOC_LITERAL(7, 111, 5) // "state"

    },
    "ECMControllerGUI\0on_pushButton_released\0"
    "\0slot_NewSensorData\0common::TupleSensorString\0"
    "sensor\0data::SensorState\0state"
};
...
void ECMControllerGUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slot_NewSensorData((*reinterpret_cast< const common::TupleSensorString(*)>(_a[1])),(*reinterpret_cast< const data::SensorState(*)>(_a[2]))); break;
        default: ;
        }
...
void *ECMControllerGUI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ECMControllerGUI.stringdata0))
        return static_cast<void*>(const_cast< ECMControllerGUI*>(this));
