...
void PlotCentral::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PlotCentral::*)(QList<common::TupleECMData> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlotCentral::ComponentsAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PlotCentral::*)(bool , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlotCentral::SelectedExpressionString)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (PlotCentral::*)(QList<common::TupleECMData> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlotCentral::ComponentsRemoved)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PlotCentral::staticMetaObject = {
