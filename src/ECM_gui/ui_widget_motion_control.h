/********************************************************************************
** Form generated from reading UI file 'widget_motion_control.ui'
**
...
#ifndef UI_WIDGET_MOTION_CONTROL_H
#define UI_WIDGET_MOTION_CONTROL_H
...
public:
    ...
    void setupUi(QWidget *Widget_MotionControl)
    {
        if (Widget_MotionControl->objectName().isEmpty())
            Widget_MotionControl->setObjectName(QStringLiteral("Widget_MotionControl"));
        Widget_MotionControl->resize(368, 268);
        Widget_MotionControl->setStyleSheet(QLatin1String("QMenuBar{\n"
...
"width:20px;\n"
"}"));
        gridLayout_3 = new QGridLayout(Widget_MotionControl);
        gridLayout_3->setObjectName(QStringLiteral("gridLayout_3"));
        frame_MaunalControl = new QFrame(Widget_MotionControl);
        ...
        retranslateUi(Widget_MotionControl);

        QMetaObject::connectSlotsByName(Widget_MotionControl);
    } // setupUi

    void retranslateUi(QWidget *Widget_MotionControl)
    {
        Widget_MotionControl->setWindowTitle(QApplication::translate("Widget_MotionControl", "Form", nullptr));
        label_ManualControl->setText(QApplication::translate("Widget_MotionControl", "Manual Control", nullptr));
        label->setText(QApplication::translate("Widget_MotionControl", "Current Position (um):", nullptr));
        label_ManualControl_3->setText(QApplication::translate("Widget_MotionControl", "Jog  (um/sec)", nullptr));
        pushButton_IncreaseJog->setText(QApplication::translate("Widget_MotionControl", "INCREASE", nullptr));
        pushButton_DecreaseJog->setText(QApplication::translate("Widget_MotionControl", "DECREASE", nullptr));
        label_ManualControl_4->setText(QApplication::translate("Widget_MotionControl", "Step (um | um/sec)", nullptr));
        pushButton_IncreaseRelativeMove->setText(QApplication::translate("Widget_MotionControl", "INCREASE", nullptr));
#ifndef QT_NO_TOOLTIP
        spinBox_RelativeMoveSpeed->setToolTip(QApplication::translate("Widget_MotionControl", "Testing1", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        spinBox_RelativeMoveSpeed->setStatusTip(QString());
#endif // QT_NO_STATUSTIP
        pushButton_DecreaseRelativeMove->setText(QApplication::translate("Widget_MotionControl", "DECREASE", nullptr));
    } // retranslateUi

};

namespace Ui {
    class Widget_MotionControl: public Ui_Widget_MotionControl {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_WIDGET_MOTION_CONTROL_H
