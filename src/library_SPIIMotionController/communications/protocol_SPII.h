...
#include "../commands/spii_command_components.h"
...
private:
    ...
    void uploadProgramSuite(const SPIICommand_UploadProgramSuite* uploadSuite);

    bool uploadProgramToBuffer(const SPIICommand_UploadProgramBuffer* uploadProgram);
