...
QT_MOC_LITERAL(49, 975, 21), // "signal_ESTOPTriggered"
QT_MOC_LITERAL(50, 997, 11) // "isTriggered"
    ...
    "common::NotificationUpdate\0update\0"
    "signal_ESTOPTriggered\0isTriggered"
};
...
static const uint qt_meta_data_SPIIMotionController[] = {
 ...
 // signals: name, argc, parameters, tag, flags
      ...
      26,    1,  134,    2, 0x06 /* Public */,
      27,    2,  137,    2, 0x06 /* Public */,
      30,    2,  142,    2, 0x06 /* Public */,
      32,    2,  147,    2, 0x06 /* Public */,
      34,    1,  152,    2, 0x06 /* Public */,
      36,    2,  155,    2, 0x06 /* Public */,
      41,    2,  160,    2, 0x06 /* Public */,
      43,    2,  165,    2, 0x06 /* Public */,
      46,    1,  170,    2, 0x06 /* Public */,
      49,    1,  173,    2, 0x06 /* Public */,
...
void SPIIMotionController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 17: _t->signal_ESTOPTriggered((*reinterpret_cast< const bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (SPIIMotionController::*_t)(const bool & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SPIIMotionController::signal_ESTOPTriggered)) {
                *result = 17;
                return;
            }
        }
...
// SIGNAL 17
void SPIIMotionController::signal_ESTOPTriggered(const bool & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
