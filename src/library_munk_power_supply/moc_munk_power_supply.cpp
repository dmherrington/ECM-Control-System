...
void MunkPowerSupply::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MunkPowerSupply::signal_ConnectionStatusUpdated)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MunkPowerSupply::signal_CommunicationError)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MunkPowerSupply::*_t)(const std::string & , const std::string & ) const;
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MunkPowerSupply::signal_CommunicationUpdate)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MunkPowerSupply::signal_FaultCodeRecieved)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MunkPowerSupply::signal_SegmentSetAck)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (MunkPowerSupply::*_t)(const std::string & , const std::string & ) const;
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MunkPowerSupply::signal_SegmentException)) {
                *result = 5;
                return;
            }
        }
