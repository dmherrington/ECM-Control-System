#ifndef STATE_ECM_SETUP_MACHINE_TOUCHOFF_EXECUTE_H
#define STATE_ECM_SETUP_MACHINE_TOUCHOFF_EXECUTE_H
...
ECM_CLASS_FORWARD(ECMState_SetupMachineTouchoffExecute);

class ECMState_SetupMachineTouchoffFailed;
class ECMState_SetupMachineTouchoffDisconnect;

class ECMState_SetupMachineTouchoffExecute : public AbstractStateECMProcess
{
public:
    ECMState_SetupMachineTouchoffExecute();
...
#endif // STATE_ECM_SETUP_MACHINE_TOUCHOFF_EXECUTE_H
