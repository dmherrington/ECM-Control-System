#ifndef STATE_ECM_UPLOAD_POWER_SUPPLY_SUCCEEDED_H
#define STATE_ECM_UPLOAD_POWER_SUPPLY_SUCCEEDED_H
...
ECM_CLASS_FORWARD(ECMState_UploadPowerSupplySucceeded);

class ECMState_UploadPowerSupplySucceeded : public AbstractStateECMProcess
{
public:
    ECMState_UploadPowerSupplySucceeded();
...
#endif // STATE_ECM_UPLOAD_POWER_SUPPLY_SUCCEEDED_H
