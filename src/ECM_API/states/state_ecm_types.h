...
enum class ECMState{
    ...
    STATE_ECM_PROFILE_MACHINE_ESTOP = 24, /**< */
    STATE_ECM_PROFILE_MACHINE_FAILED = 25, /**< */
    STATE_ECM_PROFILE_MACHINE_PAUSED = 26, /**< */
    STATE_ECM_PROFILE_MACHINE_PROCESS = 27, /**< */
    ...
    STATE_ECM_UPLOAD_POWER_SUPPLY = 55, /**< */
    STATE_ECM_UPLOAD_POWER_SUPPLY_FAILED = 56, /**< */
    STATE_ECM_UPLOAD_POWER_SUPPLY_PAUSED = 57, /**< */
    STATE_ECM_UPLOAD_POWER_SUPPLY_SUCCEEDED = 58, /**< */
    STATE_ECM_UPLOAD_POWER_PULSE_MODE = 59, /**< */
    STATE_ECM_UPLOAD_POWER_REGISTER_SEGMENTS = 60, /**< */
    STATE_ECM_UPLOAD_PUMP_PARAMETERS = 61, /**< */
    STATE_UNKNOWN = 100 /**< */
};
...
inline std::string ECMStateToString(const ECMState &type) {
    ...
    case ECMState::STATE_ECM_PROFILE_MACHINE_ESTOP:
        return "Profile Machining ESTOP Execution";
