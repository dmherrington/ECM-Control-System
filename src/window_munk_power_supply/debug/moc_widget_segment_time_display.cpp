...
void WidgetSegmentTimeDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WidgetSegmentTimeDisplay::updatedData)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject WidgetSegmentTimeDisplay::staticMetaObject = {
...
void *WidgetSegmentTimeDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WidgetSegmentTimeDisplay.stringdata0))
        return static_cast<void*>(const_cast< WidgetSegmentTimeDisplay*>(this));
    if (!strcmp(_clname, "WidgetTimeDataInterface"))
        return static_cast< WidgetTimeDataInterface*>(const_cast< WidgetSegmentTimeDisplay*>(this));
