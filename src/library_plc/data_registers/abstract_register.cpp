...
AbstractPLCRegister::AbstractPLCRegister():
    parameterCode(0),slaveAddress(3),readOrwrite(data_PLC::RWType::WRITE),highChecksum(0),lowChecksum(0)
{

}

AbstractPLCRegister::AbstractPLCRegister(const unsigned int &code):
    parameterCode(code),slaveAddress(3),readOrwrite(data_PLC::RWType::WRITE),highChecksum(0),lowChecksum(0)
{
