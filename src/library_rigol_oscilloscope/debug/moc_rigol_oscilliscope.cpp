...
QT_MOC_LITERAL(13, 241, 25), // "signal_OSCOPENotification"
QT_MOC_LITERAL(14, 267, 26), // "common::NotificationUpdate"
QT_MOC_LITERAL(15, 294, 6) // "update"
    ...
    "signal_RigolLoadComplete\0"
    "signal_OSCOPENotification\0"
...
void RigolOscilliscope::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->signal_OSCOPENotification((*reinterpret_cast< const common::NotificationUpdate(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (RigolOscilliscope::*_t)();
        ...
        {
            typedef void (RigolOscilliscope::*_t)(const common::NotificationUpdate & ) const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RigolOscilliscope::signal_OSCOPENotification)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void RigolOscilliscope::signal_OSCOPENotification(const common::NotificationUpdate & _t1)const
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(const_cast< RigolOscilliscope *>(this), &staticMetaObject, 4, _a);
}
QT_WARNING_POP
